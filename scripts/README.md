# Project 02 — Franka Pick & Place (Isaac Sim)

## 🎯 Overview

Implemented a deterministic Franka robotic arm pick-and-place pipeline in NVIDIA Isaac Sim using OpenUSD-based scene composition.

This project demonstrates **robot manipulation under physics constraints**, with emphasis on:

* coordinate system alignment
* grasp stability
* motion smoothness
* debugging real simulation failure modes
...
<video src="./media/franka_pick_place_demo.mp4" controls width="100%"></video>

---

## 📸 Scene & Grasp Setup

![Hover Pose](./images/Screenshot%20from%202026-03-27%2000-37-09.png)
![Grasp Alignment](./images/Screenshot%20from%202026-03-27%2000-44-57.png)
![Placement Result](./images/Screenshot%20from%202026-03-27%2001-15-14.png)
